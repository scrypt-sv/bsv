...
/**
 * Returns the preimage of the hash that needs to be signed
 * for OP_CHECKSIG.
 *
 * @name Signing.sighashPreimage
 ...
 *
 */
function sighashPreimage (transaction, sighashType, inputNumber, subscript, satoshisBN, flags) {
 ...
 *
 */
function sighash (transaction, sighashType, inputIndex, subscript, satoshisBN, flags) {
  var buf = sighashPreimage(transaction, sighashType, inputIndex, subscript, satoshisBN, flags)
